...
class Terrain(object):
    ...
    def update(self):
        ...
        while True:
            ...
            #time.sleep(0.05)
            if not os.path.isdir(file_path + str(self.A_date)):
                os.mkdir(file_path + str(self.A_date))
                c_path = file_path + str(self.A_date) + "/"
            ...
            if ret == True:
                ...
                if k == ord('s'):
                    if self.flag == True:
                        self.keyText_X = open(c_path + "X_train" + str(self.A_date) + ".txt", "a+")
                        self.keyText_Y = open(c_path + "Y_train" + str(self.A_date) + ".txt", "a+")
                        self.odsflag = True                       
                        self.flag = False
                    ...
                    if self.flag == True:
                        self.isTestset = True
                        self.keyText_X_test = open(c_path + "X_test" + str(self.A_date) + ".txt", "a+")
                        self.keyText_Y_test = open(c_path + "Y_test" + str(self.A_date) + ".txt", "a+")
                        self.odsflag = True
                        self.flag = False
                        self.Sw_date = self.Sw_date + 1
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='trt_tfopenpose_models_fp16', help='trt_tfopenpose_models_fp16') # trt_tfopenpose_models_fp32
