...
#cam = WebcamVideoStream("http://192.168.148.146:8080/mjpeg").start()
cam = WebcamVideoStream(0).start()

#----- Set Parameters -----#
n_steps = 120    # 每40個frame為一次動作 (40)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='trt_tfopenpose_models_fp16', help='cmu / mobilenet_frozen-opt-model / mobilenet_v2_final, mobilenet_thin, mobilenet_v2_large, mobilenet_v2_small')
